...
try{
	...
	String sql ="select * from expertanswered ";
...
<html>
  ...
  if(o != null)
  {
   ...
   %>
   <form  action = "usernoti.jsp" >
 			
 		
 		

<label for="fname">Q and A Forum</label>
<input type="text" id="fname" name="fname" value ="<%=s1 %>" size="50" disabled>
<br/>
<br/>
<input type="text" id="fname" name="ans"  value ="<%=s2 %>"  size="50" >
  <br><br>
